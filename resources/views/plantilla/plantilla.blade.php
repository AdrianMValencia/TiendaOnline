    ...
    <div class="menu">
        ...
        <div class="menu_search">
            <form action="#" id="menu_search_form" class="menu_search_form">
                ...
                <button class="menu_search_button"><img src="http://localhost:8000/asset/images/search.png"
                        alt=""></button>
            </form>
        </div>
        <!-- Navigation -->
        ...
        <div class="menu_contact">
            <div class="menu_phone d-flex flex-row align-items-center justify-content-start">
                <div>
                    <div><img src="http://localhost:8000/asset/images/phone.svg"
                    ...
                    <div class="header_search">
                        <form action="#" id="header_search_form">
                            ...
                            <button class="header_search_button"><img
                                    src="http://localhost:8000/asset/images/search.png" alt=""></button>
                        </form>
                    </div>
                    <!-- Cart -->
                    <div class="cart"><a href="cart.html">
                            <div><img class="svg" src="http://localhost:8000/asset/images/cart.svg"
                                    ...
                                    <a href="#">
                                        <div class="d-flex flex-row align-items-center justify-content-start">
                                            <div class="footer_logo_icon"><img
                                                    src="http://localhost:8000/asset/images/logo_2.png" alt=""></div>
