            ...
            <div class="owl-carousel owl-theme home_slider">
                ...
                <div class="owl-item">
                    <div class="background_image"
                        style="background-image:url(http://localhost:8000/asset/images/home_2.jpg)"></div>
                                                ...
                                                <div class="col-lg-4 col-md-6 col-sm-8 offset-sm-2 offset-md-0">
                                                    <div class="product home_item_large">
                                                        ...
                                                        <div class="product_image"><img
                                                                src="http://localhost:8000/asset/images/home_2.jpg"
                                                                alt=""></div>
                                                            ...
                                                            <div class="product_buttons">
                                                                <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div>
                                                                            <div><img
                                                                                    src="http://localhost:8000/asset/images/cart_2.svg"
                                                                                    alt="">
                                                                                <div>+</div>
                                                                            </div>
                                                                        </div>
                ...
                <div class="owl-item">
                    <div class="background_image"
                        style="background-image:url(http://localhost:8000/asset/images/product_1.jpg)"></div>
                    <div class="container fill_height">
                        <div class="row fill_height">
                            <div class="col fill_height">
                                <div class="home_container d-flex flex-column align-items-center justify-content-start">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4 col-md-6 col-sm-8 offset-sm-2 offset-md-0">
                                                    <div class="product home_item_large">
                                                        ...
                                                        <div class="product_image"><img
                                                                src="http://localhost:8000/asset/images/product_1.jpg"
                                                                alt=""></div>
                                                        <div class="product_content">
                ...
                <div class="owl-item">
                    <div class="background_image"
                        style="background-image:url(http://localhost:8000/asset/images/product_2.jpg)"></div>
                    <div class="container fill_height">
                        <div class="row fill_height">
                            <div class="col fill_height">
                                <div class="home_container d-flex flex-column align-items-center justify-content-start">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4 col-md-6 col-sm-8 offset-sm-2 offset-md-0">
                                                    <div class="product home_item_large">
                                                        ...
                                                        <div class="product_image"><img
                                                                src="http://localhost:8000/asset/images/product_2.jpg"
                                                                alt=""></div>
                                                        <div class="product_content">
                                                            <div class="product_buttons">
                                                                <div
                ...
                <div class="owl-item">
                    <div class="background_image"
                        style="background-image:url(http://localhost:8000/asset/images/product_3.jpg)"></div>
                    <div class="container fill_height">
                        <div class="row fill_height">
                            <div class="col fill_height">
                                <div class="home_container d-flex flex-column align-items-center justify-content-start">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4 col-md-6 col-sm-8 offset-sm-2 offset-md-0">
                                                    <div class="product home_item_large">
                                                        ...
                                                        <div class="product_image"><img
                                                                src="http://localhost:8000/asset/images/product_3.jpg"
                                                                alt=""></div>
                                                        <div class="product_content">
                                                            <div class="product_buttons">
                                                                <div
        ...
        <div class="container">
            ...
            <div class="row products_row">
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="product">
                        <div class="product_image"><img src="http://localhost:8000/asset/images/product_1.jpg" alt="">
                        </div>
                        <div class="product_content">
                            ...
                            <div class="product_buttons">
                                <div class="text-right d-flex flex-row align-items-start justify-content-start">
                                    <div
                                        class="product_button product_cart text-center d-flex flex-column align-items-center justify-content-center">
                                        <div>
                                            <div><img src="http://localhost:8000/asset/images/cart.svg" class="svg"
                                                    alt="">
                                                <div>+</div>
                                            </div>
                                        </div>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="product">
                        <div class="product_image"><img src="http://localhost:8000/asset/images/product_2.jpg" alt="">
                        </div>
                        <div class="product_content">
                            <div class="product_info d-flex flex-row align-items-start justify-content-start">
                                <div>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="product">
                        <div class="product_image"><img src="http://localhost:8000/asset/images/product_3.jpg" alt="">
                        </div>
                        <div class="product_content">
                            <div class="product_info d-flex flex-row align-items-start justify-content-start">
                                <div>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="product">
                        <div class="product_image"><img src="http://localhost:8000/asset/images/product_4.jpg" alt="">
                        </div>
                        <div class="product_content">
                            <div class="product_info d-flex flex-row align-items-start justify-content-start">
                                <div>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="product">
                        <div class="product_image"><img src="http://localhost:8000/asset/images/product_5.jpg" alt="">
                        </div>
                        <div class="product_content">
                            <div class="product_info d-flex flex-row align-items-start justify-content-start">
                                <div>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="product">
                        <div class="product_image"><img src="http://localhost:8000/asset/images/product_6.jpg" alt="">
                        </div>
                        <div class="product_content">
                            <div class="product_info d-flex flex-row align-items-start justify-content-start">
                                <div>
                        ...
                        <div class="product_buttons">
                            <div class="text-right d-flex flex-row align-items-start justify-content-start">
                                <div
                                    class="product_button product_cart text-center d-flex flex-column align-items-center justify-content-center">
                                    <div>
                                        <div><img src="http://localhost:8000/asset/images/cart.svg" class="svg" alt="">
                                            <div>+</div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="product">
                ...
                <div class="product_content">
                    <div class="product_info">
                        <div>
                            <div>
                                <div class="product_name product_namesinwidth text-center"><a href="product.html">Cool
                                        Clothing with Brown Stripes</a></div>
        ...
        <div class="row">
            <div class="col">
                <div class="boxes_container d-flex flex-row align-items-start justify-content-between flex-wrap">
                    ...
                    <div class="box">
                        <div class="background_image"
                            style="background-image:url(http://localhost:8000/asset/images/box_1.jpg)"></div>
                        <div class="box_content d-flex flex-row align-items-center justify-content-start">
                            <div class="box_left">
                                <div class="box_image">
                                    <a href="category.html">
                                        <div class="background_image"
                                            style="background-image:url(http://localhost:8000/asset/images/box_1_img.jpg)">
                                        </div>
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="box">
                        <div class="background_image"
                            style="background-image:url(http://localhost:8000/asset/images/box_2.jpg)"></div>
                        <div class="box_content d-flex flex-row align-items-center justify-content-start">
                            <div class="box_left">
                                <div class="box_image">
                                    <a href="category.html">
                                        <div class="background_image"
                                            style="background-image:url(http://localhost:8000/asset/images/box_2_img.jpg)">
                                        </div>
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="box">
                        <div class="background_image"
                            style="background-image:url(http://localhost:8000/asset/images/box_3.jpg)"></div>
                        <div class="box_content d-flex flex-row align-items-center justify-content-start">
                            <div class="box_left">
                                <div class="box_image">
                                    <a href="category.html">
                                        <div class="background_image"
                                            style="background-image:url(http://localhost:8000/asset/images/box_3_img.jpg)">
                                        </div>
                                    </a>
                                </div>
                            </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 feature_col">
                <div class="feature d-flex flex-row align-items-start justify-content-start">
                    <div class="feature_left">
                        <div class="feature_icon"><img src="http://localhost:8000/asset/images/icon_1.svg" alt="">
                        </div>
                    </div>
                ...
                <div class="feature d-flex flex-row align-items-start justify-content-start">
                    <div class="feature_left">
                        <div class="feature_icon ml-auto mr-auto"><img
                                src="http://localhost:8000/asset/images/icon_2.svg" alt=""></div>
                    </div>
                    <div class="feature_right d-flex flex-column align-items-start justify-content-center">
            ...
            <div class="col-lg-4 feature_col">
                <div class="feature d-flex flex-row align-items-start justify-content-start">
                    <div class="feature_left">
                        <div class="feature_icon"><img src="http://localhost:8000/asset/images/icon_3.svg" alt="">
                        </div>
                    </div>
                    <div class="feature_right d-flex flex-column align-items-start justify-content-center">
